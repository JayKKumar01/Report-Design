...
document.getElementById("alignmentValidationBtn").addEventListener("click", function() {
  // Hide the main wrapper and show the alignment validation section
  document.getElementById("wrapper").style.display = "none";
  document.getElementById("alignmentValidationDiv").style.display = "flex";

  // Switch button to selected state
  document.getElementById("alignmentValidationBtn").classList.add("selected-validation");
  document.getElementById("contentValidationBtn").classList.remove("selected-validation");
});

document.getElementById("contentValidationBtn").addEventListener("click", function() {
  // Show the main wrapper and hide the alignment validation section
  document.getElementById("wrapper").style.display = "flex";
  document.getElementById("alignmentValidationDiv").style.display = "none";

  // Switch button to selected state
  document.getElementById("contentValidationBtn").classList.add("selected-validation");
  document.getElementById("alignmentValidationBtn").classList.remove("selected-validation");
});
